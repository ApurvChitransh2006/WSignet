  ...
  return (
    <div className='fixed text-xl border-2 border-white rounded-full p-2 cursor-pointer top-2 right-2 select-none text-white z-50' >
      ...
      <div className={`${navOpen?'absolute':'hidden'} h-40 w-48 mt-2 border-2 border-white rounded-lg top-full right-0 flex flex-col justify-center p-2 bg-black `}>
        <Link to={'/dash/udash'}><div className='rounded-lg px-2 hover:bg-[#262626]'>Product List</div></Link>
        <Link to={'/dash/udash/uploaddb'}><div className='rounded-lg px-2 hover:bg-[#262626]'>Update Database</div></Link>
        <Link to={'/dash/udash/report'}><div className='rounded-lg px-2 hover:bg-[#262626]'>Generate Report</div></Link>
